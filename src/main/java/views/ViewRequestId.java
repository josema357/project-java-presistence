...
public class ViewRequestId extends JFrame{
	
	private static final long serialVersionUID = 1L;
	private JTextField idTextField;
	public ViewRequestId(JFrame previousWindow) {
		//Window configuration
		setTitle("Request message id");
		setSize(514,294);
		...
		updateButton.setBounds(379, 202, 85, 21);
		desktopPane.add(updateButton);
